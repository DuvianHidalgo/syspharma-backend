...
public partial class SyspharmaContext : IdentityDbContext<Usuario, IdentityRole<int>, int>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Cita>(entity =>
        {
            ...
            entity.Property(e => e.PacienteNombre).HasMaxLength(200).IsUnicode(false).HasColumnName("pacienteNombre");
        ...
        modelBuilder.Entity<CompraDetalle>(entity =>
        {
            ...
            entity.HasOne(d => d.Compra).WithMany(p => p.CompraDetalles).HasForeignKey(d => d.CompraId).HasConstraintName("FK_CDetalles_Compras");
            entity.HasOne(d => d.Producto).WithMany(p => p.CompraDetalles).HasForeignKey(d => d.ProductoId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_CDetalles_Productos");
        });
        ...
        modelBuilder.Entity<Gasto>(entity =>
        {
            ...
            entity.Property(e => e.Concepto).HasMaxLength(200).IsUnicode(false).HasColumnName("concepto");
            entity.Property(e => e.Descripcion).HasColumnName("descripcion");
        ...
        modelBuilder.Entity<Proveedore>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Contacto).HasMaxLength(150).IsUnicode(false).HasColumnName("contacto");
        ...
        modelBuilder.Entity<Servicio>(entity =>
        {
            ...
            entity.HasOne(d => d.Turno).WithMany(p => p.Servicios).HasForeignKey(d => d.TurnoId).OnDelete(DeleteBehavior.SetNull).HasConstraintName("FK_Servicios_Turnos");
        });
        ...
        modelBuilder.Entity<VResumenTurno>(entity =>
        {
            ...
            entity.Property(e => e.Empleado).HasMaxLength(150).IsUnicode(false).HasColumnName("empleado");
